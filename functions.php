...
function genesis_block_theme_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar - Column 4', 'genesis-block-theme' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Widgets added here will appear on the left of product tag page.', 'genesis-block-theme' ),
...
if ( ! function_exists( 'genesis_block_theme_fonts_url' ) ) :
	...
	function genesis_block_theme_fonts_url() {
		...
		$fonts_url = 'https://fonts.googleapis.com/css2?family=Work+Sans:ital,wght@0,400;1,300;1,400&display=swap';
		...
		$font = esc_html_x( 'off', 'Public Sans font: on or off', 'genesis-block-theme' );
