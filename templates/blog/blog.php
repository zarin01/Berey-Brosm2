...
if (!$query->have_posts()) {
    ?>
    <div class="notice">
        <p class="bottom"><?php _e('We are sorry, no results were found. You can try to find some related posts using the search function.', 'genesis-block-theme'); ?></p>
    </div>
    <?php get_search_form();
    ?>	
<?php } ?>
...
<div class="clear"></div>
<?php
echo jwRender::pagination(jaw_template_get_var('pagination', get_option('blog_pagination', 'number')), $query);
