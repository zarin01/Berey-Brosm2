    ...
    <?php if ($ratingManager->getRatignsShowUserRating(get_the_ID())) { ?>
        <div class="jw-rating-row jw-rating-area-percent-user-rating">                  
            ...
            <div class="jw-rating-criteria-name" >
                <span class="jw-rating-userrating-name" data-rel="<?php _e('Your rating', 'genesis-block-theme'); ?>"><?php _e('Users rating', 'genesis-block-theme'); ?>:</span>
                <span class="jw-rating-userrating-score"><?php (round($userScore / 2) / 10); ?></span>
                <span class="jw-rating-userrating-votes" data-rel="<?php _e('votes', 'genesis-block-theme'); ?>">(<?php echo $voted; ?> <?php _e('votes', 'genesis-block-theme'); ?>)</span>
            </div>
            <div class="jw-rating-area-stars">
