...
<article id="team-<?php the_ID(); ?>"  <?php post_class(array('element', 'col-lg-3', 'content-team')); ?>   >
    <div class="box ">
        ...
        <div class="image <?php echo has_post_thumbnail() === false ? 'no-image-added' : 'image-added' ?>">
            <?php
        ...
        <div class="content-box">
            ...
            <?php if (isset($meta['_team_mail'][0])) { ?>
                <div><a href="mailto:<?php echo esc_url($meta['_team_mail'][0]); ?>"><?php echo __('Email:', 'genesis-block-theme') . ' ' . esc_attr($meta['_team_mail'][0]); ?></a></div>
            <?php } ?>
            ...
            <div  class="el-social-icons team_social_icons">
                <?php if (isset($meta['_team_fb'][0])) { ?>
                    <a class="facebook" href="<?php echo esc_url($meta['_team_fb'][0]); ?>"><i class="icon-facebook4 "></i></a>
                <?php } ?>

                <?php if (isset($meta['_team_tw'][0])) { ?>
                    <a class="twitter" href="<?php echo esc_url($meta['_team_tw'][0]); ?>"><i class="icon-twitter3  "></i></a>
                <?php } ?>

                <?php if (isset($meta['_team_gp'][0])) { ?>
                    <a class="google" href="<?php echo esc_url($meta['_team_gp'][0]); ?>"><i class="icon-google-plus4  "></i></a>
                <?php } ?>

                <?php if (isset($meta['_team_lin'][0])) { ?>
                    <a class="linkedin" href="<?php echo esc_url($meta['_team_lin'][0]); ?>"><i class="icon-linkedin  "></i></a>
                <?php } ?>

                <?php if (isset($meta['_team_bl'][0])) { ?>
                    <a class="blogger" href="<?php echo esc_url($meta['_team_bl'][0]); ?>"><i class="icon-blogger2  "></i></a>
                <?php } ?>
