<?php if (get_option('blog_featured_source', 'jaw-slider') == "jaw-slider") { ?>
    <?php
        $builder_section_class = '';
        $row_class = '';
        if (get_option('jawslider_full_type', 'off') == "on") {
            $builder_section_class = 'row-fullwidth';
            $row_class = 'fullwidth-block';
        } else if (get_option('jawslider_full_type', 'off') == "full") {
...
<?php } else if (get_option('blog_featured_source', 'revo-slider') == "revo-slider") { ?>
