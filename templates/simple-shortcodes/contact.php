...
<div class="contact-contact">
    <?php if (jaw_template_get_var('mail', '') != '') { ?>
        <div class="contact-mail">
            ...
            <?php } else { ?>
                <span><?php echo __('E-mail:', 'genesis-block-theme'); ?></span> 
            <?php } ?>
    ...
    <?php if (jaw_template_get_var('phone', '') != '') { ?>
        <div class="contact-mail">
            ...
            <?php } else { ?>
                <span><?php echo __('Phone:', 'genesis-block-theme'); ?></span> 
            <?php } ?>
    ...
    <?php if (jaw_template_get_var('mobile', '') != '') { ?>
        <div class="contact-mail">
            ...
            <?php } else { ?>
                <span><?php echo __('Mobile:', 'genesis-block-theme'); ?></span> 
            <?php } ?>
    ...
    <?php if (jaw_template_get_var('web', '') != '') { ?>
        <div class="contact-mail">
            ...
            <?php } else { ?>
                <span><?php echo __('Web:', 'genesis-block-theme'); ?></span> 
            <?php } ?>
    ...
    <?php if (jaw_template_get_var('skype', '') != '') { ?>
        <div class="contact-mail">
            ...
            <?php } else { ?>
                <span><?php echo __('Skype:', 'genesis-block-theme'); ?></span> 
            <?php } ?>
...
<div class="contact-time">
    <h4><?php echo __('Opening hours:', 'genesis-block-theme'); ?></h4> 
    <?php if (jaw_template_get_var('mo', '') != '') { ?>
        <div class="contact-time-mo">
            <span><?php echo __('Monday:', 'genesis-block-theme'); ?></span> 
    ...
    <?php if (jaw_template_get_var('tu', '') != '') { ?>
        <div class="contact-time-mo">
            <span><?php echo __('Tuesday:', 'genesis-block-theme'); ?></span> 
    ...
    <?php if (jaw_template_get_var('we', '') != '') { ?>
        <div class="contact-time-mo">
            <span><?php echo __('Wednesday:', 'genesis-block-theme'); ?></span> 
    ...
    <?php if (jaw_template_get_var('th', '') != '') { ?>
        <div class="contact-time-mo">
            <span><?php echo __('Thursday:', 'genesis-block-theme'); ?></span> 
    ...
    <?php if (jaw_template_get_var('fr', '') != '') { ?>
        <div class="contact-time-mo">
            <span><?php echo __('Friday:', 'genesis-block-theme'); ?></span> 
    ...
    <?php if (jaw_template_get_var('sa', '') != '') { ?>
        <div class="contact-time-mo">
            <span><?php echo __('Saturday:', 'genesis-block-theme'); ?></span> 
    ...
    <?php if (jaw_template_get_var('su', '') != '') { ?>
        <div class="contact-time-mo">
            <span><?php echo __('Sunday:', 'genesis-block-theme'); ?></span> 
