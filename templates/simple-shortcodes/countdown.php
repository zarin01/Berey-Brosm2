...
<?php
    echo "jQuery('#counter" . jaw_template_get_var('id') . "').timeTo({timeTo:new Date(a)," . $style . "displayDays:true,titleDays:'" . __('days', 'genesis-block-theme') . "',titleHours:'" . __('hrs', 'genesis-block-theme') . "',titleMinutes:'" . __('mnts', 'genesis-block-theme') . "',titleSeconds:'" . __('sec', 'genesis-block-theme') . "'})";
?>
    });</script>  
