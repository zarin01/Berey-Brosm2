...
?>
<div class="divider divider-<?php echo jaw_template_get_var('divider_style', 'solid'); ?>  <?php echo jaw_template_get_var('clear', 'clear-off'); ?>" style="border-bottom-style:<?php echo jaw_template_get_var('divider_style', 'solid'); ?>; border-bottom-width:<?php echo jaw_template_get_var('width', '1'); ?>px;border-bottom-color:<?php echo jaw_template_get_var('color', '#000000'); ?>;color:<?php echo jaw_template_get_var('color', '#000000'); ?>; <?php echo esc_attr($style.'; '.$style_after); ?>;">
