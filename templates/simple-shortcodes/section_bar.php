...
<div class="row section-header <?php echo jaw_template_get_var('bar_type', 'box'); ?>">
    ...
    <?php if (jaw_template_get_var('bar_type', 'box') == 'line') { ?>
        <div class="section-line" style="<?php echo esc_attr($styles_line); ?>">
        ...
        <?php } else if (jaw_template_get_var('bar_type', 'box') == 'box') { ?>
            <div class="section-box box" style="<?php echo esc_attr($styles_line); ?>">
                <h<?php echo jaw_template_get_var('bar_h', '3'); ?> class="section-name" style="<?php echo esc_attr($styles_text . $styles_back); ?>" >
            ...
            <?php } else if (jaw_template_get_var('bar_type', 'box') == 'big') { ?>
                <div class="section-big-wrapper" style="<?php echo esc_attr($styles_line); ?>"> 
                <h<?php echo jaw_template_get_var('bar_h', '3'); ?> class="section-big" style="<?php echo esc_attr($styles_text); ?>" >
                        <?php echo jaw_template_get_var('box_title', ''); ?>
                </h<?php echo jaw_template_get_var('bar_h', '3'); ?>>
                <?php } else if (jaw_template_get_var('bar_type', 'box') == 'woo') { ?>     
                    ...
                    <?php } else if (jaw_template_get_var('bar_type', 'box') == 'space') { ?>     
                        ...
                        <?php } else if (jaw_template_get_var('bar_type', 'box') == 'like_divider') { ?>     
                            <div class="section-divider-wrapper" style="<?php echo esc_attr($styles_line); ?>"> 
                                <span class="divider-text"><span class="divider-center-text" style="<?php echo esc_attr($styles_text); ?>">
                                        <?php echo jaw_template_get_var('box_title', ''); ?>
                                    </span></span>
                            <?php } else { ?>   
                                <?php if (in_array(jaw_template_get_var('element_type', ''), $arrows_in_header) || jaw_template_get_var('bar_sort', '0') == '1' || jaw_template_get_var('woo_bar_sort', '0') == '1') { ?>
                                    ...
                                    <?php if (jaw_template_get_var('bar_sort', '0') == '1') { ?>
                                        <ul class="items-sortby-list">
                                            <li><?php _e('Sort: ', 'genesis-block-theme');?></li>
                                            <li><a href="#date" ><?php _e('Date', 'genesis-block-theme');?></a></li>
                                            <li><a href="#name" ><?php _e('Name', 'genesis-block-theme');?></a></li>
                                            <li><a href="#rating" ><?php _e('Rating', 'genesis-block-theme');?></a></li>
                                            <li><a href="#popular" ><?php _e('Popular', 'genesis-block-theme');?></a></li>
                                            <?php if (get_option('custom_sort1', '0') == '1') { ?>
                                                <li><a href="#custom1" ><?php echo get_option('custom_sort1_name', ''); ?></a></li>
                                            <?php } ?>
                                            <?php if (get_option('custom_sort2', '0') == '1') { ?>
                                                '<li><a href="#custom2" ><?php echo get_option('custom_sort2_name', ''); ?></a></li>
                                            <?php } ?>
                                        </ul>
                                    <?php } ?>
                                    <?php
                                    if (jaw_template_get_var('bar_filter', '0') == '1') {
                                        ...
                                        $actual_list = $jaw_data['data']['cats'];

                                        ?>
                                        <ul class="items-filter-list">
                                            <li><?php _e('Filter: ', 'genesis-block-theme');?></li>

                                            <li><a href="#" data-filter='*'><?php _e('All', 'genesis-block-theme');?></a></li>
                                            <?php foreach ($categories_list as $cl) {
                                                foreach($actual_list as $a) {
                                                    if (isset($cl->slug) && isset($cl->name) && $a == $cl->slug) {
                                                        ?>
                                                        <li><a href ="#" data-filter="<?php echo '.' . esc_attr($cl->slug); ?>"><?php echo esc_attr($cl->name); ?></a></li>
                                                        <?php
                                                    }
                                                }
                                            }
