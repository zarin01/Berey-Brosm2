...
if (class_exists('WooCommerce')) {
    ...
    <article id="product-<?php the_ID(); ?>"  <?php post_class(array('element', 'col-lg-2', 'product-style-10', 'product-animate', $catalog_mode_class)); ?>   
            ...
            <div class="image <?php echo esc_attr($class); ?>">
                ...
                <?php if ($product->is_featured()) { ?>
                    <div class="featured-bar">
                        <span><?php _e('Featured product', 'genesis-block-theme') ?></span>
                    </div>
                <?php } ?>
            </div>
